...
<div class="container">
    <div class="row">
        <div class="col-md-12 p-4">
            <h2 class="title text-secondary text-center">Busca de clientes</h2>
        </div>
    </div>
            ...
            <table class="table table-light table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if(isFraud($cliente->cpf, $cliente->data_nasc))
                                <span class="badge rounded-pill bg-danger">Possível Fraude</span>
                            @endif
                        </td>
